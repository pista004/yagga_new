...
class Admin_Model_OrderItem extends Model_Model {
    ...
    public function setOrder_item_product($product) {
        $this->_product = $product;
    }

    public function getOrder_item_product() {
        return $this->_product;
    }

    public function setOrder_item_variant($variant) {
        $this->_variant = $variant;
    }

    public function getOrder_item_variant() {
