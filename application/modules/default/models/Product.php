...
class Default_Model_Product extends Model_Model {
    ...
    protected $_variants_sum_stock;
    protected $_product_name_variant_name;
    ...
    public function setProduct_stock($stock) {
        $this->_stock = $stock;
    }
    ...
    public function setProduct_purchase_price($purchase_price) {
    ...
    public function setProduct_recommended_price($recommended_price) {
    ...
    public function setProduct_default_url($default_url) {
        $this->_default_url = $default_url;
    }

    public function getProduct_default_url() {
    ...
    public function setManufacturer(Default_Model_Manufacturer $manufacturer) {
    ...
    public function setVariants(array $variant) {
    ...
    public function setMain_photography(Default_Model_Photography $main_photography) {
    ...
    public function setPhotographies(array $photographies) {
        $this->_photographies = $photographies;
    }
    ...
    public function setCategory(Default_Model_Category $category) {
...
//  ziskam slevu k produktu
    public function getProduct_discount() {
        if ($this->_recommended_price && $this->_price) {
            if ($this->_recommended_price > $this->_price) {
                return (int) ((1 - ($this->_price / $this->_recommended_price)) * 100);
            }
        }
    }

    public function setAffiliate_program(Default_Model_AffiliateProgram $affiliateProgram) {
    ...
    public function setVariants_sum_stock($variantsSumStock) {
        $this->_variants_sum_stock = $variantsSumStock;
    }

    public function getVariants_sum_stock() {
        return $this->_variants_sum_stock;
    }
    
    public function getProduct_name_variant_name() {
        
        $this->_product_name_variant_name = $this->getProduct_name();
        
        if($this->getProduct_variant_name() != ""){
            $this->_product_name_variant_name .= ' '.$this->getProduct_variant_name();
        }
        
        return $this->_product_name_variant_name;
    }
